...
class PAMAssetsAllOfEmbeddedItemsInnerAllOfReferenceFilesInnerLink(BaseModel):
    """
    Links to get and download the reference file
    """ # noqa: E501
    var_self: Optional[PAMAssetsAllOfEmbeddedItemsInnerAllOfReferenceFilesInnerLinkSelf] = Field(default=None, alias="self")
    download: Optional[PAMAssetsAllOfEmbeddedItemsInnerAllOfReferenceFilesInnerLinkDownload] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": PAMAssetsAllOfEmbeddedItemsInnerAllOfReferenceFilesInnerLinkSelf.from_dict(obj["self"]) if obj.get("self") is not None else None,
            "download": PAMAssetsAllOfEmbeddedItemsInnerAllOfReferenceFilesInnerLinkDownload.from_dict(obj["download"]) if obj.get("download") is not None else None
        })
        return _obj
