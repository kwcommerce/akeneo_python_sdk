...
class AttributeGroupsAllOfEmbeddedItemsInner(BaseModel):
    """
    ...
    sort_order: Optional[StrictInt] = Field(default=None, description="Attribute group order among other attribute groups")
    attributes: Optional[List[StrictStr]] = Field(default=None, description="Attribute codes that compose the attribute group")
    labels: Optional[AttributeGroupsAllOfEmbeddedItemsInnerAllOfLabels] = None
    __properties: ClassVar[List[str]] = ["_links", "code", "sort_order", "attributes", "labels"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "labels": AttributeGroupsAllOfEmbeddedItemsInnerAllOfLabels.from_dict(obj["labels"]) if obj.get("labels") is not None else None
        })
        return _obj
