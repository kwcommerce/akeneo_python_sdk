...
class TestPatchProductModelsRequest(unittest.TestCase):
    """PatchProductModelsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchProductModelsRequest:
        """Test PatchProductModelsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchProductModelsRequest`
        """
        model = PatchProductModelsRequest()
        if include_optional:
            return PatchProductModelsRequest(
                code = '',
                family = '',
                family_variant = '',
                parent = 'null',
    ...
    def testPatchProductModelsRequest(self):
        """Test PatchProductModelsRequest"""
