...
class PublishedProductsAllOfEmbeddedItemsInnerAllOfValuesAttributeCodeInner(BaseModel):
    """
    PublishedProductsAllOfEmbeddedItemsInnerAllOfValuesAttributeCodeInner
    """ # noqa: E501
