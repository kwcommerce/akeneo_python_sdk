...
class ProductModelApi:
    ...
    def get_product_models(
        ...
        with_attribute_options: Annotated[Optional[StrictBool], Field(description="Return labels of attribute options in the response. <strong>(Only available on SaaS platforms)</strong>")] = None,
        ...
        :param with_attribute_options: Return labels of attribute options in the response. <strong>(Only available on SaaS platforms)</strong>
