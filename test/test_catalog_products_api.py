...
class TestCatalogProductsApi(unittest.TestCase):
    ...
    def test_get_app_catalog_mapped_models(self) -> None:
        """Test case for get_app_catalog_mapped_models
    ...
    def test_get_app_catalog_mapped_variants(self) -> None:
        """Test case for get_app_catalog_mapped_variants
