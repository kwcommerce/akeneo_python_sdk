...
class LocalesAllOfEmbeddedItemsInner(BaseModel):
    """
    LocalesAllOfEmbeddedItemsInner
    """ # noqa: E501
    links: Optional[ProductsAllOfEmbeddedItemsInnerAllOfLinks] = Field(default=None, alias="_links")
    code: StrictStr = Field(description="Locale code")
    enabled: Optional[StrictBool] = Field(default=False, description="Whether the locale is enabled")
    __properties: ClassVar[List[str]] = ["_links", "code", "enabled"]
