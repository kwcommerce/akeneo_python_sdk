...
class CurrenciesAllOfEmbeddedItemsInner(BaseModel):
    """
    ...
    enabled: Optional[StrictBool] = Field(default=None, description="Whether the currency is enabled")
    label: Optional[StrictStr] = Field(default=None, description="Currency label")
    __properties: ClassVar[List[str]] = ["_links", "code", "enabled", "label"]
