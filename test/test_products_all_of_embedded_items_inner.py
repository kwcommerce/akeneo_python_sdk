...
class TestProductsAllOfEmbeddedItemsInner(unittest.TestCase):
    """ProductsAllOfEmbeddedItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductsAllOfEmbeddedItemsInner:
        """Test ProductsAllOfEmbeddedItemsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductsAllOfEmbeddedItemsInner`
        """
        model = ProductsAllOfEmbeddedItemsInner()
        if include_optional:
            return ProductsAllOfEmbeddedItemsInner(
    ...
    def testProductsAllOfEmbeddedItemsInner(self):
        """Test ProductsAllOfEmbeddedItemsInner"""
