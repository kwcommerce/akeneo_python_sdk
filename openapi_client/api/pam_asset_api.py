...
class PAMAssetApi:
    ...
    def get_pam_assets(
        ...
        _param = self._get_pam_assets_serialize(
    ...
    @validate_call
    def get_pam_assets_with_http_info(
        self,
        pagination_type: Annotated[Optional[StrictStr], Field(description="Pagination method type, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Number of the page to retrieve when using the `page` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html#pagination\">Pagination</a> section")] = None,
        search_after: Annotated[Optional[StrictStr], Field(description="Cursor when using the `search_after` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
    ...
    @validate_call
    def get_pam_assets_without_preload_content(
        self,
        pagination_type: Annotated[Optional[StrictStr], Field(description="Pagination method type, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Number of the page to retrieve when using the `page` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html#pagination\">Pagination</a> section")] = None,
        search_after: Annotated[Optional[StrictStr], Field(description="Cursor when using the `search_after` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
    ...
    def _get_pam_assets_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/assets',
    ...
    def get_pam_assets_code(
        ...
        _param = self._get_pam_assets_code_serialize(
            code=code,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_pam_assets_code_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostPamAssetsRequest]:
        """Get a PAM asset
    ...
    @validate_call
    def get_pam_assets_code_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_pam_assets_code_serialize(
        self,
        code,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/assets/{code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def patch_pam_assets(
        self,
        body: Optional[PatchPamAssetsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param body:
        :type body: PatchPamAssetsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_pam_assets_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def patch_pam_assets_with_http_info(
        self,
        body: Optional[PatchPamAssetsRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def patch_pam_assets_without_preload_content(
        self,
        body: Optional[PatchPamAssetsRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _patch_pam_assets_serialize(
        self,
        body,
        _request_auth,
        _content_type,
    ...
    def patch_pam_assets_code(
        ...
        :type code: str
        :param body: (required)
        :type body: PostPamAssetsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_pam_assets_code_serialize(
            code=code,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def patch_pam_assets_code_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: PostPamAssetsRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def patch_pam_assets_code_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: PostPamAssetsRequest,
        _request_timeout: Union[
    ...
    def _patch_pam_assets_code_serialize(
        self,
        code,
        body,
        _request_auth,
    ...
    def post_pam_assets(
        self,
        body: Optional[PostPamAssetsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._post_pam_assets_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def post_pam_assets_with_http_info(
        self,
        body: Optional[PostPamAssetsRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_pam_assets_without_preload_content(
        self,
        body: Optional[PostPamAssetsRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _post_pam_assets_serialize(
        self,
        body,
        _request_auth,
        _content_type,
