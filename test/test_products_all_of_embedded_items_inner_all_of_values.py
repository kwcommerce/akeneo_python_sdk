...
class TestProductsAllOfEmbeddedItemsInnerAllOfValues(unittest.TestCase):
    """ProductsAllOfEmbeddedItemsInnerAllOfValues unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductsAllOfEmbeddedItemsInnerAllOfValues:
        """Test ProductsAllOfEmbeddedItemsInnerAllOfValues
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductsAllOfEmbeddedItemsInnerAllOfValues`
        """
        model = ProductsAllOfEmbeddedItemsInnerAllOfValues()
        if include_optional:
            return ProductsAllOfEmbeddedItemsInnerAllOfValues(
                attribute_code = [
    ...
    def testProductsAllOfEmbeddedItemsInnerAllOfValues(self):
        """Test ProductsAllOfEmbeddedItemsInnerAllOfValues"""
