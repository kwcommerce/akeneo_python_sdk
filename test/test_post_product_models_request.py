...
class TestPostProductModelsRequest(unittest.TestCase):
    """PostProductModelsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostProductModelsRequest:
        """Test PostProductModelsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostProductModelsRequest`
        """
        model = PostProductModelsRequest()
        if include_optional:
    ...
    def testPostProductModelsRequest(self):
        """Test PostProductModelsRequest"""
