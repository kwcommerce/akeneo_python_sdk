...
class AttributesAllOfEmbeddedItemsInnerAllOfLabels(BaseModel):
    """
    Attribute labels for each locale
    """ # noqa: E501
    locale_code: Optional[StrictStr] = Field(default=None, description="Attribute label for the locale `localeCode`", alias="localeCode")
    __properties: ClassVar[List[str]] = ["localeCode"]
