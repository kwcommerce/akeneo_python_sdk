...
**values** | [**ProductsAllOfEmbeddedItemsInnerAllOfValues**](ProductsAllOfEmbeddedItemsInnerAllOfValues.md) |  | [optional] 
...
patch_products_request_instance = PatchProductsRequest.from_json(json)
# print the JSON string representation of the object
print(PatchProductsRequest.to_json())

# convert the object into a dict
patch_products_request_dict = patch_products_request_instance.to_dict()
# create an instance of PatchProductsRequest from a dict
patch_products_request_from_dict = PatchProductsRequest.from_dict(patch_products_request_dict)
```
