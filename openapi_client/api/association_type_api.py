...
class AssociationTypeApi:
    ...
    def association_types_get(
        ...
        _param = self._association_types_get_serialize(
            code=code,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AssociationTypesPostRequest",
    ...
    @validate_call
    def association_types_get_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AssociationTypesPostRequest]:
        """Get an association type
    ...
    @validate_call
    def association_types_get_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
            None,
    ...
    def _association_types_get_serialize(
        self,
        code,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/association-types/{code}',
    ...
    @validate_call
    def association_types_get_list(
        self,
        ...
        _param = self._association_types_get_list_serialize(
            page=page,
            limit=limit,
    ...
    @validate_call
    def association_types_get_list_without_preload_content(
        self,
        page: Annotated[Optional[StrictInt], Field(description="Number of the page to retrieve when using the `page` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html#pagination\">Pagination</a> section")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
        with_count: Annotated[Optional[StrictBool], Field(description="Return the count of items in the response. Be carefull with that, on a big catalog, it can decrease performance in a significative way")] = None,
    ...
    def _association_types_get_list_serialize(
        self,
        page,
        limit,
        with_count,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/association-types',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def association_types_patch(
        ...
        :type code: str
        :param body: (required)
        :type body: AssociationTypesPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._association_types_patch_serialize(
            code=code,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def association_types_patch_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: AssociationTypesPostRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def association_types_patch_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: AssociationTypesPostRequest,
        _request_timeout: Union[
    ...
    def _association_types_patch_serialize(
        self,
        code,
        body,
        _request_auth,
    ...
    @validate_call
    def association_types_post(
        self,
        body: Optional[AssociationTypesPostRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._association_types_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def association_types_post_with_http_info(
        self,
        body: Optional[AssociationTypesPostRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def association_types_post_without_preload_content(
        self,
        body: Optional[AssociationTypesPostRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _association_types_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def several_association_types_patch(
        self,
        body: Optional[SeveralAssociationTypesPatchRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._several_association_types_patch_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def several_association_types_patch_with_http_info(
        self,
        body: Optional[SeveralAssociationTypesPatchRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def several_association_types_patch_without_preload_content(
        self,
        body: Optional[SeveralAssociationTypesPatchRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _several_association_types_patch_serialize(
        self,
        body,
        _request_auth,
        _content_type,
