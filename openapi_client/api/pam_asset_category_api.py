...
class PAMAssetCategoryApi:
    ...
    def get_asset_categories_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PAMAssetCategories]:
        """Get list of PAM asset categories
    ...
    def _get_asset_categories_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/asset-categories',
    ...
    def get_asset_categories_code(
        ...
        _param = self._get_asset_categories_code_serialize(
            code=code,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PostAssetCategoriesRequest",
            '401': "GetProductsUuid401Response",
            '403': "GetProductsUuid401Response",
    ...
    @validate_call
    def get_asset_categories_code_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostAssetCategoriesRequest]:
        """Get a PAM asset category
    ...
    @validate_call
    def get_asset_categories_code_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_asset_categories_code_serialize(
        self,
        code,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/asset-categories/{code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def patch_asset_categories(
        self,
        body: Optional[PatchAssetCategoriesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param body:
        :type body: PatchAssetCategoriesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_asset_categories_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def patch_asset_categories_with_http_info(
        self,
        body: Optional[PatchAssetCategoriesRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def patch_asset_categories_without_preload_content(
        self,
        body: Optional[PatchAssetCategoriesRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _patch_asset_categories_serialize(
        self,
        body,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def patch_asset_categories_code(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        ...
        :type code: str
        :param body: (required)
        :type body: PostAssetCategoriesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_asset_categories_code_serialize(
            code=code,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def patch_asset_categories_code_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: PostAssetCategoriesRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def patch_asset_categories_code_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: PostAssetCategoriesRequest,
        _request_timeout: Union[
    ...
    def _patch_asset_categories_code_serialize(
        self,
        code,
        body,
        _request_auth,
    ...
    @validate_call
    def post_asset_categories(
        self,
        body: Optional[PostAssetCategoriesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._post_asset_categories_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def post_asset_categories_with_http_info(
        self,
        body: Optional[PostAssetCategoriesRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_asset_categories_without_preload_content(
        self,
        body: Optional[PostAssetCategoriesRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _post_asset_categories_serialize(
        self,
        body,
        _request_auth,
        _content_type,
