...
class TestProducts1AllOfEmbeddedItemsInner(unittest.TestCase):
    """Products1AllOfEmbeddedItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Products1AllOfEmbeddedItemsInner:
        """Test Products1AllOfEmbeddedItemsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Products1AllOfEmbeddedItemsInner`
        """
        model = Products1AllOfEmbeddedItemsInner()
        if include_optional:
            return Products1AllOfEmbeddedItemsInner(
                ...
                associations = openapi_client.models.products_1_all_of__embedded_items_inner_all_of_associations.Products_1_allOf__embedded_items_inner_allOf_associations(
                ...
                quantified_associations = openapi_client.models.products_1_all_of__embedded_items_inner_all_of_quantified_associations.Products_1_allOf__embedded_items_inner_allOf_quantified_associations(
                    quantified_association_type_code = openapi_client.models.products_1_all_of__embedded_items_inner_all_of_quantified_associations_quantified_association_type_code.Products_1_allOf__embedded_items_inner_allOf_quantified_associations_quantifiedAssociationTypeCode(
                        products = [
    ...
    def testProducts1AllOfEmbeddedItemsInner(self):
        """Test Products1AllOfEmbeddedItemsInner"""
