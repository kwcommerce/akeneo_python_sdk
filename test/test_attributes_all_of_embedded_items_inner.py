...
class TestAttributesAllOfEmbeddedItemsInner(unittest.TestCase):
    """AttributesAllOfEmbeddedItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttributesAllOfEmbeddedItemsInner:
        """Test AttributesAllOfEmbeddedItemsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttributesAllOfEmbeddedItemsInner`
        """
        model = AttributesAllOfEmbeddedItemsInner()
        if include_optional:
            return AttributesAllOfEmbeddedItemsInner(
    ...
    def testAttributesAllOfEmbeddedItemsInner(self):
        """Test AttributesAllOfEmbeddedItemsInner"""
