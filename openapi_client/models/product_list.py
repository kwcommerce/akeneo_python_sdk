...
class ProductList(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_links", "uuid", "identifier", "enabled", "family", "categories", "groups", "parent", "values", "associations", "quantified_associations", "created", "updated", "metadata", "quality_scores", "completenesses"]
