...
class TestPatchProductsRequest(unittest.TestCase):
    """PatchProductsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchProductsRequest:
        """Test PatchProductsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchProductsRequest`
        """
        model = PatchProductsRequest()
        if include_optional:
            return PatchProductsRequest(
                uuid = '',
                identifier = '',
                enabled = True,
    ...
    def testPatchProductsRequest(self):
        """Test PatchProductsRequest"""
