...
class TestDeprecatedAssetCategoryList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeprecatedAssetCategoryList:
        """Test DeprecatedAssetCategoryList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeprecatedAssetCategoryList`
        """
        model = DeprecatedAssetCategoryList()
        if include_optional:
            return DeprecatedAssetCategoryList(
