...
json = "{}"
# create an instance of PatchAttributesRequest from a JSON string
patch_attributes_request_instance = PatchAttributesRequest.from_json(json)
# print the JSON string representation of the object
print(PatchAttributesRequest.to_json())

# convert the object into a dict
patch_attributes_request_dict = patch_attributes_request_instance.to_dict()
# create an instance of PatchAttributesRequest from a dict
patch_attributes_request_from_dict = PatchAttributesRequest.from_dict(patch_attributes_request_dict)
```
