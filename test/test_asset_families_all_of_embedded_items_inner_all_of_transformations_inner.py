...
class TestAssetFamiliesAllOfEmbeddedItemsInnerAllOfTransformationsInner(unittest.TestCase):
    """AssetFamiliesAllOfEmbeddedItemsInnerAllOfTransformationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssetFamiliesAllOfEmbeddedItemsInnerAllOfTransformationsInner:
        """Test AssetFamiliesAllOfEmbeddedItemsInnerAllOfTransformationsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetFamiliesAllOfEmbeddedItemsInnerAllOfTransformationsInner`
        """
        model = AssetFamiliesAllOfEmbeddedItemsInnerAllOfTransformationsInner()
        if include_optional:
            return AssetFamiliesAllOfEmbeddedItemsInnerAllOfTransformationsInner(
                label = '',
                filename_suffix = '',
                filename_prefix = '',
    ...
    def testAssetFamiliesAllOfEmbeddedItemsInnerAllOfTransformationsInner(self):
        """Test AssetFamiliesAllOfEmbeddedItemsInnerAllOfTransformationsInner"""
