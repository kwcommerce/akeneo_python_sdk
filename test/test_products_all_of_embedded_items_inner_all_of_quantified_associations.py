...
class TestProductsAllOfEmbeddedItemsInnerAllOfQuantifiedAssociations(unittest.TestCase):
    """ProductsAllOfEmbeddedItemsInnerAllOfQuantifiedAssociations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductsAllOfEmbeddedItemsInnerAllOfQuantifiedAssociations:
        """Test ProductsAllOfEmbeddedItemsInnerAllOfQuantifiedAssociations
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductsAllOfEmbeddedItemsInnerAllOfQuantifiedAssociations`
        """
        model = ProductsAllOfEmbeddedItemsInnerAllOfQuantifiedAssociations()
        if include_optional:
            return ProductsAllOfEmbeddedItemsInnerAllOfQuantifiedAssociations(
    ...
    def testProductsAllOfEmbeddedItemsInnerAllOfQuantifiedAssociations(self):
        """Test ProductsAllOfEmbeddedItemsInnerAllOfQuantifiedAssociations"""
