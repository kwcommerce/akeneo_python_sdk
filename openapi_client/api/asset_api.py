...
class AssetApi:
    ...
    def get_assets_code_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAssetsCode200Response]:
        """Get an asset of a given asset family
    ...
    def patch_asset_code(
        ...
        :type code: str
        :param body: (required)
        :type body: GetAssetsCode200Response
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def patch_assets(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[PatchReferenceEntityRecords200ResponseInner]:
    ...
    def patch_assets_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[PatchReferenceEntityRecords200ResponseInner]]:
        """Update/create several assets
