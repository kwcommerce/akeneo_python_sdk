...
class AssetFamilyList(BaseModel):
    """
    AssetFamilyList
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "naming_convention": AssetFamilyListAllOfNamingConvention.from_dict(obj["naming_convention"]) if obj.get("naming_convention") is not None else None,
