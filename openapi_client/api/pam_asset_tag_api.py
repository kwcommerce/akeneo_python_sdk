...
class PAMAssetTagApi:
    ...
    def get_asset_tags(
        ...
        _param = self._get_asset_tags_serialize(
            page=page,
            limit=limit,
    ...
    @validate_call
    def get_asset_tags_with_http_info(
        self,
        page: Annotated[Optional[StrictInt], Field(description="Number of the page to retrieve when using the `page` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html#pagination\">Pagination</a> section")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
        with_count: Annotated[Optional[StrictBool], Field(description="Return the count of items in the response. Be carefull with that, on a big catalog, it can decrease performance in a significative way")] = None,
    ...
    @validate_call
    def get_asset_tags_without_preload_content(
        self,
        page: Annotated[Optional[StrictInt], Field(description="Number of the page to retrieve when using the `page` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html#pagination\">Pagination</a> section")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
        with_count: Annotated[Optional[StrictBool], Field(description="Return the count of items in the response. Be carefull with that, on a big catalog, it can decrease performance in a significative way")] = None,
    ...
    def _get_asset_tags_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/asset-tags',
    ...
    def get_asset_tags_code(
        ...
        _param = self._get_asset_tags_code_serialize(
            code=code,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetAssetTagsCode200Response",
            '401': "GetProductsUuid401Response",
            '403': "GetProductsUuid401Response",
    ...
    @validate_call
    def get_asset_tags_code_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAssetTagsCode200Response]:
        """Get a PAM asset tag
    ...
    @validate_call
    def get_asset_tags_code_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_asset_tags_code_serialize(
        self,
        code,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/asset-tags/{code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def patch_asset_tags_code(
        ...
        :type code: str
        :param body: (required)
        :type body: GetAssetTagsCode200Response
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_asset_tags_code_serialize(
            code=code,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def patch_asset_tags_code_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: GetAssetTagsCode200Response,
        _request_timeout: Union[
    ...
    @validate_call
    def patch_asset_tags_code_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: GetAssetTagsCode200Response,
        _request_timeout: Union[
    ...
    def _patch_asset_tags_code_serialize(
        self,
        code,
        body,
        _request_auth,
