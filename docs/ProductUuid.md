...
product_uuid_instance = ProductUuid.from_json(json)
# print the JSON string representation of the object
print(ProductUuid.to_json())

# convert the object into a dict
product_uuid_dict = product_uuid_instance.to_dict()
# create an instance of ProductUuid from a dict
product_uuid_from_dict = ProductUuid.from_dict(product_uuid_dict)
```
