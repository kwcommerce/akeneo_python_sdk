...
class ProductUuidApi:
    ...
    def delete_products_uuid_uuid(
        ...
        _param = self._delete_products_uuid_uuid_serialize(
            uuid=uuid,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': None,
            '401': "GetProductsUuid401Response",
            '403': "GetProductsUuid401Response",
            '404': "GetProductsUuid401Response",
        }
    ...
    @validate_call
    def delete_products_uuid_uuid_with_http_info(
        self,
        uuid: Annotated[StrictStr, Field(description="Uuid of the resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_products_uuid_uuid_without_preload_content(
        self,
        uuid: Annotated[StrictStr, Field(description="Uuid of the resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_products_uuid_uuid_serialize(
        self,
        uuid,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/rest/v1/products-uuid/{uuid}',
    ...
    def get_draft_uuid_uuid(
        ...
        _param = self._get_draft_uuid_uuid_serialize(
            uuid=uuid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PostProductsUuidRequest",
            '401': "GetProductsUuid401Response",
            '403': "GetProductsUuid401Response",
            '404': "GetProductsUuid401Response",
            '406': "GetProductsUuid401Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_draft_uuid_uuid_with_http_info(
        self,
        uuid: Annotated[StrictStr, Field(description="Uuid of the resource")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostProductsUuidRequest]:
        """Get a draft
    ...
    @validate_call
    def get_draft_uuid_uuid_without_preload_content(
        self,
        uuid: Annotated[StrictStr, Field(description="Uuid of the resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_draft_uuid_uuid_serialize(
        self,
        uuid,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/products-uuid/{uuid}/draft',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_products_uuid(
        ...
        with_attribute_options: Annotated[Optional[StrictBool], Field(description="Return labels of attribute options in the response. See <a href='/concepts/products.html#the-linked_data-format'>the `linked_data` format</a> section for more details. (Only available since the 5.0 version)")] = None,
        with_asset_share_links: Annotated[Optional[StrictBool], Field(description="Return asset collection share link urls in the response. See <a href='/concepts/products.html#the-linked_data-format'>the `linked_data` format</a> section for more details. (Only available in the SaaS version)")] = None,
        ...
        :param with_attribute_options: Return labels of attribute options in the response. See <a href='/concepts/products.html#the-linked_data-format'>the `linked_data` format</a> section for more details. (Only available since the 5.0 version)
        :type with_attribute_options: bool
        :param with_asset_share_links: Return asset collection share link urls in the response. See <a href='/concepts/products.html#the-linked_data-format'>the `linked_data` format</a> section for more details. (Only available in the SaaS version)
        :type with_asset_share_links: bool
        ...
        _param = self._get_products_uuid_serialize(
            search=search,
            scope=scope,
            locales=locales,
            ...
            with_asset_share_links=with_asset_share_links,
    ...
    @validate_call
    def get_products_uuid_with_http_info(
        self,
        search: Annotated[Optional[StrictStr], Field(description="Filter products, for more details see the <a href=\"/documentation/filter.html\">Filters</a> section")] = None,
        scope: Annotated[Optional[StrictStr], Field(description="Filter product values to return scopable attributes for the given channel as well as the non localizable/non scopable attributes, for more details see the <a href=\"/documentation/filter.html#via-channel\">Filter product values via channel</a> section")] = None,
        locales: Annotated[Optional[StrictStr], Field(description="Filter product values to return localizable attributes for the given locales as well as the non localizable/non scopable attributes, for more details see the <a href=\"/documentation/filter.html#via-locale\">Filter product values via locale</a> section")] = None,
    ...
    @validate_call
    def get_products_uuid_without_preload_content(
        self,
        search: Annotated[Optional[StrictStr], Field(description="Filter products, for more details see the <a href=\"/documentation/filter.html\">Filters</a> section")] = None,
        scope: Annotated[Optional[StrictStr], Field(description="Filter product values to return scopable attributes for the given channel as well as the non localizable/non scopable attributes, for more details see the <a href=\"/documentation/filter.html#via-channel\">Filter product values via channel</a> section")] = None,
        locales: Annotated[Optional[StrictStr], Field(description="Filter product values to return localizable attributes for the given locales as well as the non localizable/non scopable attributes, for more details see the <a href=\"/documentation/filter.html#via-locale\">Filter product values via locale</a> section")] = None,
    ...
    def _get_products_uuid_serialize(
        self,
        search,
        scope,
        locales,
        ...
        if with_asset_share_links is not None:
            
            _query_params.append(('with_asset_share_links', with_asset_share_links))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/products-uuid',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_products_uuid_uuid(
        ...
        _param = self._get_products_uuid_uuid_serialize(
            uuid=uuid,
            with_attribute_options=with_attribute_options,
            with_asset_share_links=with_asset_share_links,
            with_quality_scores=with_quality_scores,
    ...
    @validate_call
    def get_products_uuid_uuid_with_http_info(
        self,
        uuid: Annotated[StrictStr, Field(description="Uuid of the resource")],
        with_attribute_options: Annotated[Optional[StrictBool], Field(description="Return labels of attribute options in the response. See <a href='/concepts/products.html#the-linked_data-format'>the `linked_data` format</a> section for more details. (Only available since the 5.0 version)")] = None,
        with_asset_share_links: Annotated[Optional[StrictBool], Field(description="Return asset collection share link urls in the response. See <a href='/concepts/products.html#the-linked_data-format'>the `linked_data` format</a> section for more details. (Only available in the SaaS version)")] = None,
    ...
    @validate_call
    def get_products_uuid_uuid_without_preload_content(
        self,
        uuid: Annotated[StrictStr, Field(description="Uuid of the resource")],
        with_attribute_options: Annotated[Optional[StrictBool], Field(description="Return labels of attribute options in the response. See <a href='/concepts/products.html#the-linked_data-format'>the `linked_data` format</a> section for more details. (Only available since the 5.0 version)")] = None,
        with_asset_share_links: Annotated[Optional[StrictBool], Field(description="Return asset collection share link urls in the response. See <a href='/concepts/products.html#the-linked_data-format'>the `linked_data` format</a> section for more details. (Only available in the SaaS version)")] = None,
    ...
    def _get_products_uuid_uuid_serialize(
        self,
        uuid,
        with_attribute_options,
        with_asset_share_links,
    ...
    @validate_call
    def patch_products_uuid(
        self,
        body: Optional[PatchProductsUuidRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param body:
        :type body: PatchProductsUuidRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_products_uuid_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PatchProductsUuid200Response",
            '401': "GetProductsUuid401Response",
            '403': "GetProductsUuid401Response",
            '413': "GetProductsUuid401Response",
    ...
    @validate_call
    def patch_products_uuid_with_http_info(
        self,
        body: Optional[PatchProductsUuidRequest] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PatchProductsUuid200Response]:
        """Update/create several products
    ...
    @validate_call
    def patch_products_uuid_without_preload_content(
        self,
        body: Optional[PatchProductsUuidRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _patch_products_uuid_serialize(
        self,
        body,
        _request_auth,
        _content_type,
    ...
    def patch_products_uuid_uuid(
        ...
        _param = self._patch_products_uuid_uuid_serialize(
            uuid=uuid,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _patch_products_uuid_uuid_serialize(
        self,
        uuid,
        body,
        _request_auth,
    ...
    @validate_call
    def post_products_uuid(
        self,
        body: Optional[PostProductsUuidRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._post_products_uuid_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def post_products_uuid_with_http_info(
        self,
        body: Optional[PostProductsUuidRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_products_uuid_without_preload_content(
        self,
        body: Optional[PostProductsUuidRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _post_products_uuid_serialize(
        self,
        body,
        _request_auth,
        _content_type,
    ...
    def post_proposal_uuid(
        ...
        _param = self._post_proposal_uuid_serialize(
            uuid=uuid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def post_proposal_uuid_with_http_info(
        self,
        uuid: Annotated[StrictStr, Field(description="Uuid of the resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_proposal_uuid_without_preload_content(
        self,
        uuid: Annotated[StrictStr, Field(description="Uuid of the resource")],
        _request_timeout: Union[
            None,
    ...
    def _post_proposal_uuid_serialize(
        self,
        uuid,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/rest/v1/products-uuid/{uuid}/proposal',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
