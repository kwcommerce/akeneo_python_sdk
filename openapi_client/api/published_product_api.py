...
class PublishedProductApi:
    ...
    def get_published_products(
        self,
        search: Annotated[Optional[StrictStr], Field(description="Filter published products, for more details see the <a href=\"/documentation/filter.html\">Filters</a> section")] = None,
        scope: Annotated[Optional[StrictStr], Field(description="Filter published product values to return scopable attributes for the given channel as well as the non localizable/non scopable attributes, for more details see the <a href=\"/documentation/filter.html#filter-published-product-values\">Filter on published product values</a> section")] = None,
        locales: Annotated[Optional[StrictStr], Field(description="Filter published product values to return localizable attributes for the given locales as well as the non localizable/non scopable attributes, for more details see the <a href=\"/documentation/filter.html#filter-published-product-values\">Filter on published product values</a> section")] = None,
        attributes: Annotated[Optional[StrictStr], Field(description="Filter published product values to only return those concerning the given attributes, for more details see the <a href=\"/documentation/filter.html#filter-product-values\">Filter on product values</a> section")] = None,
        ...
        _param = self._get_published_products_serialize(
            search=search,
            scope=scope,
            locales=locales,
    ...
    @validate_call
    def get_published_products_with_http_info(
        self,
        search: Annotated[Optional[StrictStr], Field(description="Filter published products, for more details see the <a href=\"/documentation/filter.html\">Filters</a> section")] = None,
        scope: Annotated[Optional[StrictStr], Field(description="Filter published product values to return scopable attributes for the given channel as well as the non localizable/non scopable attributes, for more details see the <a href=\"/documentation/filter.html#filter-published-product-values\">Filter on published product values</a> section")] = None,
        locales: Annotated[Optional[StrictStr], Field(description="Filter published product values to return localizable attributes for the given locales as well as the non localizable/non scopable attributes, for more details see the <a href=\"/documentation/filter.html#filter-published-product-values\">Filter on published product values</a> section")] = None,
    ...
    @validate_call
    def get_published_products_without_preload_content(
        self,
        search: Annotated[Optional[StrictStr], Field(description="Filter published products, for more details see the <a href=\"/documentation/filter.html\">Filters</a> section")] = None,
        scope: Annotated[Optional[StrictStr], Field(description="Filter published product values to return scopable attributes for the given channel as well as the non localizable/non scopable attributes, for more details see the <a href=\"/documentation/filter.html#filter-published-product-values\">Filter on published product values</a> section")] = None,
        locales: Annotated[Optional[StrictStr], Field(description="Filter published product values to return localizable attributes for the given locales as well as the non localizable/non scopable attributes, for more details see the <a href=\"/documentation/filter.html#filter-published-product-values\">Filter on published product values</a> section")] = None,
    ...
    def _get_published_products_serialize(
        self,
        search,
        scope,
        locales,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/published-products',
    ...
    @validate_call
    def get_published_products_code(
        self,
        ...
        _param = self._get_published_products_code_serialize(
            code=code,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetPublishedProductsCode200Response",
            '401': "GetProductsUuid401Response",
            '403': "GetProductsUuid401Response",
    ...
    @validate_call
    def get_published_products_code_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetPublishedProductsCode200Response]:
        """Get a published product
    ...
    @validate_call
    def get_published_products_code_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_published_products_code_serialize(
        self,
        code,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/published-products/{code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
