...
class CatalogProductsApi:
    ...
    @validate_call
    def get_app_catalog_mapped_models(
        self,
        ...
        updated_before: Annotated[Optional[date], Field(description="Filter products that have been updated BEFORE the provided date (Only available on Catalogs endpoints). This filter uses the PIM products updated date.")] = None,
        updated_after: Annotated[Optional[date], Field(description="Filter products that have been updated AFTER the provided date (Only available on Catalogs endpoints). This filter uses the PIM products updated date.")] = None,
        ...
        :type limit: int
        :param updated_before: Filter products that have been updated BEFORE the provided date (Only available on Catalogs endpoints). This filter uses the PIM products updated date.
        :type updated_before: date
        :param updated_after: Filter products that have been updated AFTER the provided date (Only available on Catalogs endpoints). This filter uses the PIM products updated date.
        ...
        _param = self._get_app_catalog_mapped_models_serialize(
            id=id,
    ...
    @validate_call
    def get_app_catalog_mapped_models_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Catalog ID")],
        search_after: Annotated[Optional[StrictStr], Field(description="Cursor when using the `search_after` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
    ...
    @validate_call
    def get_app_catalog_mapped_models_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Catalog ID")],
        search_after: Annotated[Optional[StrictStr], Field(description="Cursor when using the `search_after` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
    ...
    def _get_app_catalog_mapped_models_serialize(
        self,
        id,
        search_after,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/catalogs/{id}/mapped-models',
    ...
    @validate_call
    def get_app_catalog_mapped_variants(
        self,
        id: Annotated[StrictStr, Field(description="Catalog ID")],
        model_code: Annotated[StrictStr, Field(description="Model code")],
        search_after: Annotated[Optional[StrictStr], Field(description="Cursor when using the `search_after` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
        updated_before: Annotated[Optional[date], Field(description="Filter products that have been updated BEFORE the provided date (Only available on Catalogs endpoints). This filter uses the PIM products updated date.")] = None,
        updated_after: Annotated[Optional[date], Field(description="Filter products that have been updated AFTER the provided date (Only available on Catalogs endpoints). This filter uses the PIM products updated date.")] = None,
        ...
        :param id: Catalog ID (required)
        :type id: str
        :param model_code: Model code (required)
        :type model_code: str
        :param search_after: Cursor when using the `search_after` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html\">Pagination</a> section
        :type search_after: str
        :param limit: Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section
        ...
        _param = self._get_app_catalog_mapped_variants_serialize(
            id=id,
    ...
    @validate_call
    def get_app_catalog_mapped_variants_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Catalog ID")],
        model_code: Annotated[StrictStr, Field(description="Model code")],
        search_after: Annotated[Optional[StrictStr], Field(description="Cursor when using the `search_after` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
    ...
    @validate_call
    def get_app_catalog_mapped_variants_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Catalog ID")],
        model_code: Annotated[StrictStr, Field(description="Model code")],
        search_after: Annotated[Optional[StrictStr], Field(description="Cursor when using the `search_after` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
    ...
    def _get_app_catalog_mapped_variants_serialize(
        self,
        id,
        model_code,
        search_after,
        ...
        if model_code is not None:
            _path_params['model_code'] = model_code
        # process the query parameters
        if search_after is not None:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/catalogs/{id}/mapped-models/{model_code}/variants',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_app_catalog_product_uuids(
        ...
        updated_before: Annotated[Optional[date], Field(description="Filter products that have been updated BEFORE the provided date (Only available on Catalogs endpoints). This filter uses the PIM products updated date.")] = None,
        updated_after: Annotated[Optional[date], Field(description="Filter products that have been updated AFTER the provided date (Only available on Catalogs endpoints). This filter uses the PIM products updated date.")] = None,
        with_count: Annotated[Optional[StrictBool], Field(description="Return the count of items in the response.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param updated_after: Filter products that have been updated AFTER the provided date (Only available on Catalogs endpoints). This filter uses the PIM products updated date.
        :type updated_after: date
        :param with_count: Return the count of items in the response.
