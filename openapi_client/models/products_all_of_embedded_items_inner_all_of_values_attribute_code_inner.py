...
class ProductsAllOfEmbeddedItemsInnerAllOfValuesAttributeCodeInner(BaseModel):
    """
    ...
    linked_data: Optional[ProductsAllOfEmbeddedItemsInnerAllOfValuesAttributeCodeInnerLinkedData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": obj.get("data"),
            "linked_data": ProductsAllOfEmbeddedItemsInnerAllOfValuesAttributeCodeInnerLinkedData.from_dict(obj["linked_data"]) if obj.get("linked_data") is not None else None,
