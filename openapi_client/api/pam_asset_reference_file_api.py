...
class PAMAssetReferenceFileApi:
    ...
    @validate_call
    def get_reference_files_channel_code_locale_code_download(
        self,
        ...
        _param = self._get_reference_files_channel_code_locale_code_download_serialize(
    ...
    @validate_call
    def get_reference_files_channel_code_locale_code_download_with_http_info(
        self,
        asset_code: Annotated[StrictStr, Field(description="Code of the asset")],
        locale_code: Annotated[StrictStr, Field(description="Code of the locale if the asset is localizable or equal to `no-locale` if the asset is not localizable")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_reference_files_channel_code_locale_code_download_without_preload_content(
        self,
        asset_code: Annotated[StrictStr, Field(description="Code of the asset")],
        locale_code: Annotated[StrictStr, Field(description="Code of the locale if the asset is localizable or equal to `no-locale` if the asset is not localizable")],
        _request_timeout: Union[
    ...
    def _get_reference_files_channel_code_locale_code_download_serialize(
        self,
        asset_code,
        locale_code,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/assets/{asset_code}/reference-files/{locale_code}/download',
    ...
    @validate_call
    def get_reference_files_locale_code(
        self,
        asset_code: Annotated[StrictStr, Field(description="Code of the asset")],
        locale_code: Annotated[StrictStr, Field(description="Code of the locale if the asset is localizable or equal to `no-locale` if the asset is not localizable")],
        _request_timeout: Union[
        ...
        _param = self._get_reference_files_locale_code_serialize(
            asset_code=asset_code,
            locale_code=locale_code,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetReferenceFilesLocaleCode200Response",
            '401': "GetProductsUuid401Response",
            '403': "GetProductsUuid401Response",
            '404': "GetProductsUuid401Response",
    ...
    @validate_call
    def get_reference_files_locale_code_with_http_info(
        self,
        asset_code: Annotated[StrictStr, Field(description="Code of the asset")],
        locale_code: Annotated[StrictStr, Field(description="Code of the locale if the asset is localizable or equal to `no-locale` if the asset is not localizable")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetReferenceFilesLocaleCode200Response]:
        """Get a reference file
    ...
    @validate_call
    def get_reference_files_locale_code_without_preload_content(
        self,
        asset_code: Annotated[StrictStr, Field(description="Code of the asset")],
        locale_code: Annotated[StrictStr, Field(description="Code of the locale if the asset is localizable or equal to `no-locale` if the asset is not localizable")],
        _request_timeout: Union[
    ...
    def _get_reference_files_locale_code_serialize(
        self,
        asset_code,
        locale_code,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/assets/{asset_code}/reference-files/{locale_code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_reference_files_locale_code(
        self,
        asset_code: Annotated[StrictStr, Field(description="Code of the asset")],
        locale_code: Annotated[StrictStr, Field(description="Code of the locale if the asset is localizable or equal to `no-locale` if the asset is not localizable")],
        ...
        _param = self._post_reference_files_locale_code_serialize(
            asset_code=asset_code,
            locale_code=locale_code,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "PostReferenceFilesLocaleCode201Response",
    ...
    @validate_call
    def post_reference_files_locale_code_with_http_info(
        self,
        asset_code: Annotated[StrictStr, Field(description="Code of the asset")],
        locale_code: Annotated[StrictStr, Field(description="Code of the locale if the asset is localizable or equal to `no-locale` if the asset is not localizable")],
        content_type: Annotated[StrictStr, Field(description="Equal to 'multipart/form-data', no other value allowed")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostReferenceFilesLocaleCode201Response]:
        """Upload a new reference file
    ...
    @validate_call
    def post_reference_files_locale_code_without_preload_content(
        self,
        asset_code: Annotated[StrictStr, Field(description="Code of the asset")],
        locale_code: Annotated[StrictStr, Field(description="Code of the locale if the asset is localizable or equal to `no-locale` if the asset is not localizable")],
        content_type: Annotated[StrictStr, Field(description="Equal to 'multipart/form-data', no other value allowed")],
    ...
    def _post_reference_files_locale_code_serialize(
        self,
        asset_code,
        locale_code,
        content_type,
