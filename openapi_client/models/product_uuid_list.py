...
class ProductUuidList(BaseModel):
    """
    ProductUuidList
    """ # noqa: E501
    ...
    values: Optional[ProductListAllOfValues] = None
    ...
    __properties: ClassVar[List[str]] = ["_links", "uuid", "enabled", "family", "categories", "groups", "parent", "values", "associations", "quantified_associations", "created", "updated", "metadata", "quality_scores", "completenesses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "values": ProductListAllOfValues.from_dict(obj["values"]) if obj.get("values") is not None else None,
