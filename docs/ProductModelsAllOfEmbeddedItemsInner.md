...
product_models_all_of_embedded_items_inner_instance = ProductModelsAllOfEmbeddedItemsInner.from_json(json)
# print the JSON string representation of the object
print(ProductModelsAllOfEmbeddedItemsInner.to_json())

# convert the object into a dict
product_models_all_of_embedded_items_inner_dict = product_models_all_of_embedded_items_inner_instance.to_dict()
# create an instance of ProductModelsAllOfEmbeddedItemsInner from a dict
product_models_all_of_embedded_items_inner_from_dict = ProductModelsAllOfEmbeddedItemsInner.from_dict(product_models_all_of_embedded_items_inner_dict)
```
