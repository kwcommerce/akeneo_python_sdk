...
class TestMeasureFamiliesAllOfEmbeddedItemsInner(unittest.TestCase):
    """MeasureFamiliesAllOfEmbeddedItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeasureFamiliesAllOfEmbeddedItemsInner:
        """Test MeasureFamiliesAllOfEmbeddedItemsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeasureFamiliesAllOfEmbeddedItemsInner`
        """
        model = MeasureFamiliesAllOfEmbeddedItemsInner()
        if include_optional:
            return MeasureFamiliesAllOfEmbeddedItemsInner(
    ...
    def testMeasureFamiliesAllOfEmbeddedItemsInner(self):
        """Test MeasureFamiliesAllOfEmbeddedItemsInner"""
