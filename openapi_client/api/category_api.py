...
class CategoryApi:
    ...
    def get_categories(
        self,
        search: Annotated[Optional[StrictStr], Field(description="Filter categories, for more details see the <a href=\"/documentation/filter.html#filter-categories\">Filters</a> section.")] = None,
        ...
        with_position: Annotated[Optional[StrictBool], Field(description="Return information about category position into its category tree (only available since the 7.0 version)")] = None,
        with_enriched_attributes: Annotated[Optional[StrictBool], Field(description="Return attribute values of the category (only available on SaaS platforms)")] = None,
        ...
        _param = self._get_categories_serialize(
            ...
            with_enriched_attributes=with_enriched_attributes,
    ...
    def _get_categories_serialize(
        ...
        if with_position is not None:
            ...
            _query_params.append(('with_position', with_position))
            
        if with_enriched_attributes is not None:
            
            _query_params.append(('with_enriched_attributes', with_enriched_attributes))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/categories',
    ...
    def get_categories_code(
        ...
        _param = self._get_categories_code_serialize(
            code=code,
            with_position=with_position,
            with_enriched_attributes=with_enriched_attributes,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetCategoriesCode200Response",
            '401': "GetProductsUuid401Response",
            '403': "GetProductsUuid401Response",
    ...
    @validate_call
    def get_categories_code_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        with_position: Annotated[Optional[StrictBool], Field(description="Return information about category position into its category tree (only available since the 7.0 version)")] = None,
        with_enriched_attributes: Annotated[Optional[StrictBool], Field(description="Return attribute values of the category (only available on SaaS platforms)")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCategoriesCode200Response]:
        """Get a category
    ...
    @validate_call
    def get_categories_code_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        with_position: Annotated[Optional[StrictBool], Field(description="Return information about category position into its category tree (only available since the 7.0 version)")] = None,
        with_enriched_attributes: Annotated[Optional[StrictBool], Field(description="Return attribute values of the category (only available on SaaS platforms)")] = None,
    ...
    def _get_categories_code_serialize(
        self,
        code,
        with_position,
        with_enriched_attributes,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/categories/{code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_category_media_files_file_path_download(
        self,
        file_path: Annotated[StrictStr, Field(description="Path of the resource")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param file_path: Path of the resource (required)
        :type file_path: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_category_media_files_file_path_download_serialize(
            file_path=file_path,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_category_media_files_file_path_download_with_http_info(
        self,
        file_path: Annotated[StrictStr, Field(description="Path of the resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_category_media_files_file_path_download_without_preload_content(
        self,
        file_path: Annotated[StrictStr, Field(description="Path of the resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_category_media_files_file_path_download_serialize(
        self,
        file_path,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/category-media-files/{file_path}/download',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def patch_categories(
        self,
        body: Optional[PatchCategoriesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._patch_categories_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def patch_categories_with_http_info(
        self,
        body: Optional[PatchCategoriesRequest] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PatchProducts200Response]:
        """Update/create several categories
    ...
    @validate_call
    def patch_categories_without_preload_content(
        self,
        body: Optional[PatchCategoriesRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _patch_categories_serialize(
        self,
        body,
        _request_auth,
        _content_type,
    ...
    def patch_categories_code(
        ...
        :type code: str
        :param body: (required)
        :type body: PostCategoriesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_categories_code_serialize(
            code=code,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def patch_categories_code_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: PostCategoriesRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def patch_categories_code_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: PostCategoriesRequest,
        _request_timeout: Union[
    ...
    def _patch_categories_code_serialize(
        self,
        code,
        body,
        _request_auth,
    ...
    def post_categories(
        self,
        body: Optional[PostCategoriesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._post_categories_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def post_categories_with_http_info(
        self,
        body: Optional[PostCategoriesRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_categories_without_preload_content(
        self,
        body: Optional[PostCategoriesRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _post_categories_serialize(
        self,
        body,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def post_category_media_files(
        self,
        content_type: Annotated[StrictStr, Field(description="Equal to 'multipart/form-data'.")],
        body: Optional[PostCategoryMediaFilesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param content_type: Equal to 'multipart/form-data'. (required)
        :type content_type: str
        :param body:
        :type body: PostCategoryMediaFilesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_category_media_files_serialize(
    ...
    @validate_call
    def post_category_media_files_with_http_info(
        self,
        content_type: Annotated[StrictStr, Field(description="Equal to 'multipart/form-data'.")],
        body: Optional[PostCategoryMediaFilesRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def post_category_media_files_without_preload_content(
        self,
        content_type: Annotated[StrictStr, Field(description="Equal to 'multipart/form-data'.")],
        body: Optional[PostCategoryMediaFilesRequest] = None,
        _request_timeout: Union[
    ...
    def _post_category_media_files_serialize(
        self,
        content_type,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/rest/v1/category-media-files',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
