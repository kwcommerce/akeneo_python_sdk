...
class PAMAssetsAllOfEmbeddedItemsInnerAllOfVariationFilesInnerLink(BaseModel):
    """
    Links to get and download the variation file
    """ # noqa: E501
    var_self: Optional[PAMAssetsAllOfEmbeddedItemsInnerAllOfVariationFilesInnerLinkSelf] = Field(default=None, alias="self")
    download: Optional[PAMAssetsAllOfEmbeddedItemsInnerAllOfVariationFilesInnerLinkDownload] = None
    __properties: ClassVar[List[str]] = ["self", "download"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": PAMAssetsAllOfEmbeddedItemsInnerAllOfVariationFilesInnerLinkSelf.from_dict(obj["self"]) if obj.get("self") is not None else None,
            "download": PAMAssetsAllOfEmbeddedItemsInnerAllOfVariationFilesInnerLinkDownload.from_dict(obj["download"]) if obj.get("download") is not None else None
        })
        return _obj
