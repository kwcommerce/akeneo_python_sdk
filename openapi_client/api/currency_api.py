...
class CurrencyApi:
    ...
    def currencies_get_list(
        self,
        search: Annotated[Optional[StrictStr], Field(description="Filter currencies, for more details see the <a href=\"/documentation/filter.html#filter-currencies\">Filters</a> section")] = None,
        ...
        :param search: Filter currencies, for more details see the <a href=\"/documentation/filter.html#filter-currencies\">Filters</a> section
        :type search: str
