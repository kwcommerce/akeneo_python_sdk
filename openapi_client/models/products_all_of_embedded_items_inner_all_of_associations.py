...
class ProductsAllOfEmbeddedItemsInnerAllOfAssociations(BaseModel):
    """
    Several associations related to groups, product models and/or other products, grouped by association types
    """ # noqa: E501
    association_type_code: Optional[ProductsAllOfEmbeddedItemsInnerAllOfAssociationsAssociationTypeCode] = Field(default=None, alias="associationTypeCode")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "associationTypeCode": ProductsAllOfEmbeddedItemsInnerAllOfAssociationsAssociationTypeCode.from_dict(obj["associationTypeCode"]) if obj.get("associationTypeCode") is not None else None
        })
        return _obj
