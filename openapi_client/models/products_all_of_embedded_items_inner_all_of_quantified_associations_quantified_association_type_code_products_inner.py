...
class ProductsAllOfEmbeddedItemsInnerAllOfQuantifiedAssociationsQuantifiedAssociationTypeCodeProductsInner(BaseModel):
    """
    ProductsAllOfEmbeddedItemsInnerAllOfQuantifiedAssociationsQuantifiedAssociationTypeCodeProductsInner
    """ # noqa: E501
    uuid: Optional[StrictStr] = None
    quantity: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["uuid", "quantity"]
