...
class TestPatchProductsUuidUuidRequest(unittest.TestCase):
    """PatchProductsUuidUuidRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchProductsUuidUuidRequest:
        """Test PatchProductsUuidUuidRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchProductsUuidUuidRequest`
        """
        model = PatchProductsUuidUuidRequest()
        if include_optional:
            return PatchProductsUuidUuidRequest(
                uuid = '',
                enabled = True,
    ...
    def testPatchProductsUuidUuidRequest(self):
        """Test PatchProductsUuidUuidRequest"""
