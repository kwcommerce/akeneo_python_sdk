...
class MeasureFamilies(BaseModel):
    """
    MeasureFamilies
    """ # noqa: E501
    links: Optional[ProductsAllOfLinks] = Field(default=None, alias="_links")
    current_page: Optional[StrictInt] = Field(default=None, description="Current page number")
    embedded: Optional[MeasureFamiliesAllOfEmbedded] = Field(default=None, alias="_embedded")
    __properties: ClassVar[List[str]] = ["_links", "current_page", "_embedded"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": ProductsAllOfLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "current_page": obj.get("current_page"),
            "_embedded": MeasureFamiliesAllOfEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None
        })
        return _obj
