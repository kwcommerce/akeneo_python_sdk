...
class ProductsAllOfLinksPrevious(BaseModel):
    """
    ProductsAllOfLinksPrevious
    """ # noqa: E501
    href: Optional[StrictStr] = Field(default=None, description="URI of the previous page of resources")
