...
class AttributeOptionApi:
    ...
    @validate_call
    def get_attributes_attribute_code_options(
        self,
        ...
        _param = self._get_attributes_attribute_code_options_serialize(
    ...
    @validate_call
    def get_attributes_attribute_code_options_with_http_info(
        self,
        attribute_code: Annotated[StrictStr, Field(description="Code of the attribute")],
        page: Annotated[Optional[StrictInt], Field(description="Number of the page to retrieve when using the `page` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html#pagination\">Pagination</a> section")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
    ...
    @validate_call
    def get_attributes_attribute_code_options_without_preload_content(
        self,
        attribute_code: Annotated[StrictStr, Field(description="Code of the attribute")],
        page: Annotated[Optional[StrictInt], Field(description="Number of the page to retrieve when using the `page` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html#pagination\">Pagination</a> section")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
    ...
    def _get_attributes_attribute_code_options_serialize(
        self,
        attribute_code,
        page,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/attributes/{attribute_code}/options',
    ...
    @validate_call
    def get_attributes_attribute_code_options_code(
        self,
        attribute_code: Annotated[StrictStr, Field(description="Code of the attribute")],
        ...
        _param = self._get_attributes_attribute_code_options_code_serialize(
            attribute_code=attribute_code,
            code=code,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PostAttributesAttributeCodeOptionsRequest",
            '401': "GetProductsUuid401Response",
            '403': "GetProductsUuid401Response",
    ...
    @validate_call
    def get_attributes_attribute_code_options_code_with_http_info(
        self,
        attribute_code: Annotated[StrictStr, Field(description="Code of the attribute")],
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostAttributesAttributeCodeOptionsRequest]:
        """Get an attribute option
    ...
    @validate_call
    def get_attributes_attribute_code_options_code_without_preload_content(
        self,
        attribute_code: Annotated[StrictStr, Field(description="Code of the attribute")],
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
    ...
    def _get_attributes_attribute_code_options_code_serialize(
        self,
        attribute_code,
        code,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/attributes/{attribute_code}/options/{code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def patch_attributes_attribute_code_options(
        self,
        attribute_code: Annotated[StrictStr, Field(description="Code of the attribute")],
        body: Optional[PatchAttributesAttributeCodeOptionsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._patch_attributes_attribute_code_options_serialize(
            attribute_code=attribute_code,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '429': "GetProductsUuid401Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def patch_attributes_attribute_code_options_with_http_info(
        self,
        attribute_code: Annotated[StrictStr, Field(description="Code of the attribute")],
        body: Optional[PatchAttributesAttributeCodeOptionsRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def patch_attributes_attribute_code_options_without_preload_content(
        self,
        attribute_code: Annotated[StrictStr, Field(description="Code of the attribute")],
        body: Optional[PatchAttributesAttributeCodeOptionsRequest] = None,
        _request_timeout: Union[
    ...
    def _patch_attributes_attribute_code_options_serialize(
        self,
        attribute_code,
        body,
        _request_auth,
    ...
    @validate_call
    def patch_attributes_attribute_code_options_code(
        self,
        attribute_code: Annotated[StrictStr, Field(description="Code of the attribute")],
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        ...
        :type code: str
        :param body: (required)
        :type body: PostAttributesAttributeCodeOptionsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_attributes_attribute_code_options_code_serialize(
            attribute_code=attribute_code,
            code=code,
            body=body,
            _request_auth=_request_auth,
    ...
    @validate_call
    def patch_attributes_attribute_code_options_code_with_http_info(
        self,
        attribute_code: Annotated[StrictStr, Field(description="Code of the attribute")],
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: PostAttributesAttributeCodeOptionsRequest,
    ...
    @validate_call
    def patch_attributes_attribute_code_options_code_without_preload_content(
        self,
        attribute_code: Annotated[StrictStr, Field(description="Code of the attribute")],
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: PostAttributesAttributeCodeOptionsRequest,
    ...
    def _patch_attributes_attribute_code_options_code_serialize(
        self,
        attribute_code,
        code,
        body,
    ...
    @validate_call
    def post_attributes_attribute_code_options(
        self,
        attribute_code: Annotated[StrictStr, Field(description="Code of the attribute")],
        body: Optional[PostAttributesAttributeCodeOptionsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._post_attributes_attribute_code_options_serialize(
            attribute_code=attribute_code,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def post_attributes_attribute_code_options_with_http_info(
        self,
        attribute_code: Annotated[StrictStr, Field(description="Code of the attribute")],
        body: Optional[PostAttributesAttributeCodeOptionsRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def post_attributes_attribute_code_options_without_preload_content(
        self,
        attribute_code: Annotated[StrictStr, Field(description="Code of the attribute")],
        body: Optional[PostAttributesAttributeCodeOptionsRequest] = None,
        _request_timeout: Union[
    ...
    def _post_attributes_attribute_code_options_serialize(
        self,
        attribute_code,
        body,
        _request_auth,
