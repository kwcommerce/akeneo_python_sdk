...
class PublishedProductList(BaseModel):
    """
    ...
    values: Optional[PublishedProductListAllOfValues] = None
    ...
    __properties: ClassVar[List[str]] = ["_links", "identifier", "enabled", "family", "categories", "groups", "values", "associations", "quantified_associations", "created", "updated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "values": PublishedProductListAllOfValues.from_dict(obj["values"]) if obj.get("values") is not None else None,
