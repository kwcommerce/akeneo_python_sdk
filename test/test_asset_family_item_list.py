...
class TestAssetFamilyItemList(unittest.TestCase):
    """AssetFamilyItemList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssetFamilyItemList:
        """Test AssetFamilyItemList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetFamilyItemList`
        """
        model = AssetFamilyItemList()
        if include_optional:
            return AssetFamilyItemList(
    ...
    def testAssetFamilyItemList(self):
        """Test AssetFamilyItemList"""
