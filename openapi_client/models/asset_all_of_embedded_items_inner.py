...
class AssetAllOfEmbeddedItemsInner(BaseModel):
    """
    ...
    values: Optional[AssetAllOfEmbeddedItemsInnerAllOfValues] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "values": AssetAllOfEmbeddedItemsInnerAllOfValues.from_dict(obj["values"]) if obj.get("values") is not None else None,
