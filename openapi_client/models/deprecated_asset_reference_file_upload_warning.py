...
class DeprecatedAssetReferenceFileUploadWarning(BaseModel):
    """
    DeprecatedAssetReferenceFileUploadWarning
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Message explaining the warning")
    errors: Optional[List[PostReferenceFilesLocaleCode201ResponseErrorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors": [PostReferenceFilesLocaleCode201ResponseErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
