...
class PAMAssetTags(BaseModel):
    ...
    embedded: Optional[PAMAssetTagsAllOfEmbedded] = Field(default=None, alias="_embedded")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_embedded": PAMAssetTagsAllOfEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None
        })
        return _obj
