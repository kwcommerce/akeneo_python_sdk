...
class TestAssetFamiliesAllOfEmbeddedItemsInner(unittest.TestCase):
    """AssetFamiliesAllOfEmbeddedItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssetFamiliesAllOfEmbeddedItemsInner:
        """Test AssetFamiliesAllOfEmbeddedItemsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetFamiliesAllOfEmbeddedItemsInner`
        """
        model = AssetFamiliesAllOfEmbeddedItemsInner()
        if include_optional:
            return AssetFamiliesAllOfEmbeddedItemsInner(
                ...
                naming_convention = openapi_client.models.asset_families_all_of__embedded_items_inner_all_of_naming_convention.Asset_families_allOf__embedded_items_inner_allOf_naming_convention(
    ...
    def testAssetFamiliesAllOfEmbeddedItemsInner(self):
        """Test AssetFamiliesAllOfEmbeddedItemsInner"""
