...
class AssetFamiliesAllOfEmbeddedItemsInnerAllOfProductLinkRulesInnerAssignAssetsToInner(BaseModel):
    """
    ...
    mode: StrictStr
    __properties: ClassVar[List[str]] = ["attribute", "locale", "channel", "mode"]
