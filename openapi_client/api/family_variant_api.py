...
class FamilyVariantApi:
    ...
    @validate_call
    def get_families_family_code_variants(
        self,
        ...
        _param = self._get_families_family_code_variants_serialize(
    ...
    @validate_call
    def get_families_family_code_variants_with_http_info(
        self,
        family_code: Annotated[StrictStr, Field(description="Code of the family")],
        page: Annotated[Optional[StrictInt], Field(description="Number of the page to retrieve when using the `page` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html#pagination\">Pagination</a> section")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
    ...
    @validate_call
    def get_families_family_code_variants_without_preload_content(
        self,
        family_code: Annotated[StrictStr, Field(description="Code of the family")],
        page: Annotated[Optional[StrictInt], Field(description="Number of the page to retrieve when using the `page` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html#pagination\">Pagination</a> section")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
    ...
    def _get_families_family_code_variants_serialize(
        self,
        family_code,
        page,
        limit,
    ...
    @validate_call
    def get_families_family_code_variants_code(
        self,
        family_code: Annotated[StrictStr, Field(description="Code of the family")],
        ...
        _param = self._get_families_family_code_variants_code_serialize(
            family_code=family_code,
            code=code,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PostFamiliesFamilyCodeVariantsRequest",
            '401': "GetProductsUuid401Response",
            '403': "GetProductsUuid401Response",
    ...
    @validate_call
    def get_families_family_code_variants_code_with_http_info(
        self,
        family_code: Annotated[StrictStr, Field(description="Code of the family")],
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostFamiliesFamilyCodeVariantsRequest]:
        """Get a family variant
    ...
    @validate_call
    def get_families_family_code_variants_code_without_preload_content(
        self,
        family_code: Annotated[StrictStr, Field(description="Code of the family")],
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
    ...
    def _get_families_family_code_variants_code_serialize(
        self,
        family_code,
        code,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/families/{family_code}/variants/{code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def patch_families_family_code_variants(
        self,
        family_code: Annotated[StrictStr, Field(description="Code of the family")],
        body: Optional[PatchFamiliesFamilyCodeVariantsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type family_code: str
        :param body:
        :type body: PatchFamiliesFamilyCodeVariantsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_families_family_code_variants_serialize(
            family_code=family_code,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def patch_families_family_code_variants_with_http_info(
        self,
        family_code: Annotated[StrictStr, Field(description="Code of the family")],
        body: Optional[PatchFamiliesFamilyCodeVariantsRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def patch_families_family_code_variants_without_preload_content(
        self,
        family_code: Annotated[StrictStr, Field(description="Code of the family")],
        body: Optional[PatchFamiliesFamilyCodeVariantsRequest] = None,
        _request_timeout: Union[
    ...
    def _patch_families_family_code_variants_serialize(
        self,
        family_code,
        body,
        _request_auth,
    ...
    @validate_call
    def patch_families_family_code_variants_code(
        self,
        family_code: Annotated[StrictStr, Field(description="Code of the family")],
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        ...
        _param = self._patch_families_family_code_variants_code_serialize(
            family_code=family_code,
            code=code,
            body=body,
            _request_auth=_request_auth,
    ...
    @validate_call
    def patch_families_family_code_variants_code_with_http_info(
        self,
        family_code: Annotated[StrictStr, Field(description="Code of the family")],
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: PostFamiliesFamilyCodeVariantsRequest,
    ...
    @validate_call
    def patch_families_family_code_variants_code_without_preload_content(
        self,
        family_code: Annotated[StrictStr, Field(description="Code of the family")],
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: PostFamiliesFamilyCodeVariantsRequest,
    ...
    def _patch_families_family_code_variants_code_serialize(
        self,
        family_code,
        code,
        body,
