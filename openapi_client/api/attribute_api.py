...
class AttributeApi:
    ...
    def get_attributes(
        self,
        search: Annotated[Optional[StrictStr], Field(description="Filter attributes, for more details see the <a href=\"/documentation/filter.html#filter-attributes\">Filters</a> section.")] = None,
        ...
        with_table_select_options: Annotated[Optional[StrictBool], Field(description="Return the options of 'select' column types (of a table attribute) in the response. (Only available since the 7.0 version)")] = None,
        ...
        _param = self._get_attributes_serialize(
            ...
            with_table_select_options=with_table_select_options,
    ...
    def _get_attributes_serialize(
        ...
        if with_table_select_options is not None:
            
            _query_params.append(('with_table_select_options', with_table_select_options))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/attributes',
    ...
    def get_attributes_code(
        ...
        _param = self._get_attributes_code_serialize(
            code=code,
            with_table_select_options=with_table_select_options,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_attributes_code_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        with_table_select_options: Annotated[Optional[StrictBool], Field(description="Return the options of 'select' column types (of a table attribute) in the response. (Only available since the 7.0 version)")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostAttributesRequest]:
        """Get an attribute
    ...
    @validate_call
    def get_attributes_code_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        with_table_select_options: Annotated[Optional[StrictBool], Field(description="Return the options of 'select' column types (of a table attribute) in the response. (Only available since the 7.0 version)")] = None,
        _request_timeout: Union[
    ...
    def _get_attributes_code_serialize(
        self,
        code,
        with_table_select_options,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/attributes/{code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def patch_attributes(
        self,
        body: Optional[PatchAttributesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._patch_attributes_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def patch_attributes_with_http_info(
        self,
        body: Optional[PatchAttributesRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def patch_attributes_without_preload_content(
        self,
        body: Optional[PatchAttributesRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _patch_attributes_serialize(
        self,
        body,
        _request_auth,
        _content_type,
    ...
    def patch_attributes_code(
        ...
        :type code: str
        :param body: (required)
        :type body: PostAttributesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_attributes_code_serialize(
            code=code,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def patch_attributes_code_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: PostAttributesRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def patch_attributes_code_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: PostAttributesRequest,
        _request_timeout: Union[
    ...
    def _patch_attributes_code_serialize(
        self,
        code,
        body,
        _request_auth,
    ...
    def post_attributes(
        self,
        body: Optional[PostAttributesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
