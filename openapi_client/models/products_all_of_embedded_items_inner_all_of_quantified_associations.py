...
class ProductsAllOfEmbeddedItemsInnerAllOfQuantifiedAssociations(BaseModel):
    """
    ...
    """ # noqa: E501
    quantified_association_type_code: Optional[ProductsAllOfEmbeddedItemsInnerAllOfQuantifiedAssociationsQuantifiedAssociationTypeCode] = Field(default=None, alias="quantifiedAssociationTypeCode")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "quantifiedAssociationTypeCode": ProductsAllOfEmbeddedItemsInnerAllOfQuantifiedAssociationsQuantifiedAssociationTypeCode.from_dict(obj["quantifiedAssociationTypeCode"]) if obj.get("quantifiedAssociationTypeCode") is not None else None
        })
        return _obj
