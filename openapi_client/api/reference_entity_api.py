...
class ReferenceEntityApi:
    ...
    def get_reference_entities(
        ...
        _param = self._get_reference_entities_serialize(
    ...
    @validate_call
    def get_reference_entities_with_http_info(
        self,
        search_after: Annotated[Optional[StrictStr], Field(description="Cursor when using the `search_after` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_reference_entities_without_preload_content(
        self,
        search_after: Annotated[Optional[StrictStr], Field(description="Cursor when using the `search_after` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_reference_entities_serialize(
        self,
        search_after,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/reference-entities',
    ...
    @validate_call
    def get_reference_entities_code(
        self,
        ...
        _param = self._get_reference_entities_code_serialize(
            code=code,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_reference_entities_code_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetReferenceEntitiesCode200Response]:
        """Get a reference entity
    ...
    @validate_call
    def get_reference_entities_code_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_reference_entities_code_serialize(
        self,
        code,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/reference-entities/{code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def patch_reference_entity_code(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        ...
        :type code: str
        :param body: (required)
        :type body: PatchReferenceEntityCodeRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_reference_entity_code_serialize(
            code=code,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def patch_reference_entity_code_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: PatchReferenceEntityCodeRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def patch_reference_entity_code_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: PatchReferenceEntityCodeRequest,
        _request_timeout: Union[
    ...
    def _patch_reference_entity_code_serialize(
        self,
        code,
        body,
        _request_auth,
