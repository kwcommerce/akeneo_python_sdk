...
class AssetMediaFileApi:
    ...
    @validate_call
    def get_asset_media_files_code(
        self,
        ...
        _param = self._get_asset_media_files_code_serialize(
            code=code,
    ...
    @validate_call
    def get_asset_media_files_code_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_asset_media_files_code_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_asset_media_files_code_serialize(
        self,
        code,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/asset-media-files/{code}',
    ...
    def post_asset_media_files(
        ...
        _param = self._post_asset_media_files_serialize(
    ...
    @validate_call
    def post_asset_media_files_with_http_info(
        self,
        content_type: Annotated[StrictStr, Field(description="Equal to 'multipart/form-data', no other value allowed")],
        body: Optional[PostReferenceEntityMediaFilesRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def post_asset_media_files_without_preload_content(
        self,
        content_type: Annotated[StrictStr, Field(description="Equal to 'multipart/form-data', no other value allowed")],
        body: Optional[PostReferenceEntityMediaFilesRequest] = None,
        _request_timeout: Union[
    ...
    def _post_asset_media_files_serialize(
        self,
        content_type,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/rest/v1/asset-media-files',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
