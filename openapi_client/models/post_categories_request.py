...
class PostCategoriesRequest(BaseModel):
    """
    ...
    values: Optional[List[PostCategoriesRequestValuesInner]] = Field(default=None, description="Attribute values (only available on SaaS).")
    __properties: ClassVar[List[str]] = ["code", "parent", "updated", "position", "labels", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "values": [PostCategoriesRequestValuesInner.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
