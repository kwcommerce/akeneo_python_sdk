...
class PatchProductsUuidUuidRequest(BaseModel):
    """
    ...
    values: Optional[Dict[str, List[ProductsAllOfEmbeddedItemsInnerAllOfValuesAttributeCodeInner]]] = Field(default=None, description="Product attributes values, see <a href='/concepts/products.html#focus-on-the-product-values'>Product values</a> section for more details")
    associations: Optional[ProductsAllOfEmbeddedItemsInnerAllOfAssociations] = None
    quantified_associations: Optional[ProductsAllOfEmbeddedItemsInnerAllOfQuantifiedAssociations] = None
    ...
    __properties: ClassVar[List[str]] = ["uuid", "enabled", "family", "categories", "groups", "parent", "values", "associations", "quantified_associations", "created", "updated", "metadata", "quality_scores", "completenesses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "values": dict(
                (_k,
                        [ProductsAllOfEmbeddedItemsInnerAllOfValuesAttributeCodeInner.from_dict(_item) for _item in _v]
                        if _v is not None
                        else None
                )
                for _k, _v in obj.get("values", {}).items()
            ),
            "associations": ProductsAllOfEmbeddedItemsInnerAllOfAssociations.from_dict(obj["associations"]) if obj.get("associations") is not None else None,
            "quantified_associations": ProductsAllOfEmbeddedItemsInnerAllOfQuantifiedAssociations.from_dict(obj["quantified_associations"]) if obj.get("quantified_associations") is not None else None,
