...
json = "{}"
# create an instance of AttributesAllOfEmbeddedItemsInner from a JSON string
attributes_all_of_embedded_items_inner_instance = AttributesAllOfEmbeddedItemsInner.from_json(json)
# print the JSON string representation of the object
print(AttributesAllOfEmbeddedItemsInner.to_json())

# convert the object into a dict
attributes_all_of_embedded_items_inner_dict = attributes_all_of_embedded_items_inner_instance.to_dict()
# create an instance of AttributesAllOfEmbeddedItemsInner from a dict
attributes_all_of_embedded_items_inner_from_dict = AttributesAllOfEmbeddedItemsInner.from_dict(attributes_all_of_embedded_items_inner_dict)
```
