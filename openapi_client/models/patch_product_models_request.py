...
class PatchProductModelsRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["code", "family", "family_variant", "parent", "categories", "values", "associations", "quantified_associations", "created", "updated", "metadata", "quality_scores"]
