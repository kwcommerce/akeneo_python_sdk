...
class TestPostAttributesRequest(unittest.TestCase):
    """PostAttributesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostAttributesRequest:
        """Test PostAttributesRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostAttributesRequest`
        """
        model = PostAttributesRequest()
        if include_optional:
    ...
    def testPostAttributesRequest(self):
        """Test PostAttributesRequest"""
