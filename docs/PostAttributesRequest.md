...
post_attributes_request_instance = PostAttributesRequest.from_json(json)
# print the JSON string representation of the object
print(PostAttributesRequest.to_json())

# convert the object into a dict
post_attributes_request_dict = post_attributes_request_instance.to_dict()
# create an instance of PostAttributesRequest from a dict
post_attributes_request_from_dict = PostAttributesRequest.from_dict(post_attributes_request_dict)
```
