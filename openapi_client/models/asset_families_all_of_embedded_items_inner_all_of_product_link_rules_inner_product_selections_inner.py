...
class AssetFamiliesAllOfEmbeddedItemsInnerAllOfProductLinkRulesInnerProductSelectionsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["field", "operator", "value", "locale", "channel"]
