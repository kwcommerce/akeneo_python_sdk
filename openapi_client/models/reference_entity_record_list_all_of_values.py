...
class ReferenceEntityRecordListAllOfValues(BaseModel):
    """
    ...
    """ # noqa: E501
    attribute_code: Optional[List[ReferenceEntityRecordListAllOfValuesAttributeCode]] = Field(default=None, alias="attributeCode")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributeCode": [ReferenceEntityRecordListAllOfValuesAttributeCode.from_dict(_item) for _item in obj["attributeCode"]] if obj.get("attributeCode") is not None else None
        })
        return _obj
