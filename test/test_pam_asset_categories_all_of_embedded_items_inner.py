...
class TestPAMAssetCategoriesAllOfEmbeddedItemsInner(unittest.TestCase):
    """PAMAssetCategoriesAllOfEmbeddedItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PAMAssetCategoriesAllOfEmbeddedItemsInner:
        """Test PAMAssetCategoriesAllOfEmbeddedItemsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PAMAssetCategoriesAllOfEmbeddedItemsInner`
        """
        model = PAMAssetCategoriesAllOfEmbeddedItemsInner()
        if include_optional:
            return PAMAssetCategoriesAllOfEmbeddedItemsInner(
    ...
    def testPAMAssetCategoriesAllOfEmbeddedItemsInner(self):
        """Test PAMAssetCategoriesAllOfEmbeddedItemsInner"""
