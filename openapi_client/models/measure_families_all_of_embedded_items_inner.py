...
class MeasureFamiliesAllOfEmbeddedItemsInner(BaseModel):
    """
    ...
    standard: Optional[StrictStr] = Field(default=None, description="Measure family standard")
    units: Optional[List[MeasureFamiliesAllOfEmbeddedItemsInnerAllOfUnitsInner]] = Field(default=None, description="Family units")
    __properties: ClassVar[List[str]] = ["_links", "code", "standard", "units"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "units": [MeasureFamiliesAllOfEmbeddedItemsInnerAllOfUnitsInner.from_dict(_item) for _item in obj["units"]] if obj.get("units") is not None else None
        })
        return _obj
