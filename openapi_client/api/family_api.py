...
class FamilyApi:
    ...
    def delete_families_code(
        ...
        _param = self._delete_families_code_serialize(
            code=code,
    ...
    @validate_call
    def delete_families_code_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_families_code_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_families_code_serialize(
        self,
        code,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/rest/v1/families/{code}',
    ...
    def get_families(
        self,
        search: Annotated[Optional[StrictStr], Field(description="Filter families, for more details see the <a href=\"/documentation/filter.html#filter-families\">Filters</a> section.")] = None,
        ...
        _param = self._get_families_serialize(
            search=search,
            page=page,
            limit=limit,
    ...
    @validate_call
    def get_families_with_http_info(
        self,
        search: Annotated[Optional[StrictStr], Field(description="Filter families, for more details see the <a href=\"/documentation/filter.html#filter-families\">Filters</a> section.")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Number of the page to retrieve when using the `page` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html#pagination\">Pagination</a> section")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
    ...
    @validate_call
    def get_families_without_preload_content(
        self,
        search: Annotated[Optional[StrictStr], Field(description="Filter families, for more details see the <a href=\"/documentation/filter.html#filter-families\">Filters</a> section.")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Number of the page to retrieve when using the `page` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html#pagination\">Pagination</a> section")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None,
    ...
    def _get_families_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/rest/v1/families',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_families_code(
        ...
        _param = self._get_families_code_serialize(
            code=code,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_families_code_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostFamiliesRequest]:
        """Get a family
    ...
    @validate_call
    def get_families_code_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_families_code_serialize(
        self,
        code,
        _request_auth,
        _content_type,
    ...
    def patch_families(
        self,
        body: Optional[PatchFamiliesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._patch_families_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def patch_families_with_http_info(
        self,
        body: Optional[PatchFamiliesRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def patch_families_without_preload_content(
        self,
        body: Optional[PatchFamiliesRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def patch_families_code(
        ...
        _param = self._patch_families_code_serialize(
            code=code,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def patch_families_code_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: PostFamiliesRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def patch_families_code_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Code of the resource")],
        body: PostFamiliesRequest,
        _request_timeout: Union[
    ...
    def _patch_families_code_serialize(
        self,
        code,
        body,
        _request_auth,
    ...
    def post_families(
        self,
        body: Optional[PostFamiliesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._post_families_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def post_families_with_http_info(
        self,
        body: Optional[PostFamiliesRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_families_without_preload_content(
        self,
        body: Optional[PostFamiliesRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_families_family_code_variants(
        self,
        family_code: Annotated[StrictStr, Field(description="Code of the family")],
        body: Optional[PostFamiliesFamilyCodeVariantsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param body:
        :type body: PostFamiliesFamilyCodeVariantsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_families_family_code_variants_serialize(
    ...
    @validate_call
    def post_families_family_code_variants_with_http_info(
        self,
        family_code: Annotated[StrictStr, Field(description="Code of the family")],
        body: Optional[PostFamiliesFamilyCodeVariantsRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def post_families_family_code_variants_without_preload_content(
        self,
        family_code: Annotated[StrictStr, Field(description="Code of the family")],
        body: Optional[PostFamiliesFamilyCodeVariantsRequest] = None,
        _request_timeout: Union[
    ...
    def _post_families_family_code_variants_serialize(
        self,
        family_code,
        body,
        _request_auth,
        ...
        if family_code is not None:
            _path_params['family_code'] = family_code
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/rest/v1/families/{family_code}/variants',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
