...
class ProductsAllOfEmbeddedItemsInnerAllOfLinksSelf(BaseModel):
    """
    ProductsAllOfEmbeddedItemsInnerAllOfLinksSelf
    """ # noqa: E501
    href: Optional[StrictStr] = Field(default=None, description="URI of the resource")
