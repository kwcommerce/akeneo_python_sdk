...
class ProductsAllOfLinksFirst(BaseModel):
    """
    ProductsAllOfLinksFirst
    """ # noqa: E501
    href: Optional[StrictStr] = Field(default=None, description="URI of the first page of resources")
