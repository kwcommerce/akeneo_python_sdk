...
class ProductsAllOfEmbeddedItemsInnerAllOfQuantifiedAssociationsQuantifiedAssociationTypeCodeProductModelsInner(BaseModel):
    """
    ProductsAllOfEmbeddedItemsInnerAllOfQuantifiedAssociationsQuantifiedAssociationTypeCodeProductModelsInner
    """ # noqa: E501
    code: Optional[StrictStr] = None
    quantity: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["code", "quantity"]
